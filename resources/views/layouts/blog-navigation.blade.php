    ...
    >
        ...
        <div class="-mr-4 flex items-center">
            ...
            <div class="ml-8 hidden space-x-8 md:flex">
                ...
                <a
                    class="px-3 py-2 {{ request()->routeIs('mis-posts') ? 'text-sky-500' : 'text-slate-600 transition-colors hover:text-sky-500 dark:text-slate-400 dark:hover:text-sky-500' }}"
